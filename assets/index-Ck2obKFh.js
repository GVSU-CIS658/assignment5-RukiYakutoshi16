 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function wI(n,e){const t=ml(n,"auth");if(t.isInitialized()){const s=t.getImmediate(),i=t.getOptions();if(vr(i,e??{}))return s;tn(s,"already-initialized")}return t.initialize({options:e})}function AI(n,e){const t=(e==null?void 0:e.persistence)||[],r=(Array.isArray(t)?t:[t]).map(pn);e!=null&&e.errorMap&&n._updateErrorMap(e.errorMap),n._initializeWithPersistence(r,e==null?void 0:e.popupRedirectResolver)}function bI(n,e,t){const r=da(n);ne(/^https?:\/\//.test(e),r,"invalid-emulator-scheme");const s=!1,i=ig(e),{host:a,port:c}=SI(e),l=c===null?"":`:${c}`,h={url:`${i}//${a}${l}/`},d=Object.freeze({host:a,port:c,protocol:i.replace(":",""),options:Object.freeze({disableWarnings:s})});if(!r._canInitEmulator){ne(r.config.emulator&&r.emulatorConfig,r,"emulator-config-failed"),ne(vr(h,r.config.emulator)&&vr(d,r.emulatorConfig),r,"emulator-config-failed");return}r.config.emulator=h,r.emulatorConfig=d,r.settings.appVerificationDisabledForTesting=!0,hs(a)?(xp(`${i}//${a}${l}`),Mp("Auth",!0)):RI()}function ig(n){const e=n.indexOf(":");return e<0?"":n.substr(0,e+1)}function SI(n){const e=ig(n),t=/(\/\/)?([^?#/]+)/.exec(n.substr(e.length));if(!t)return{host:"",port:null};const r=t[2].split("@").pop()||"",s=/^(\[[^\]]+\])(:|$)/.exec(r);if(s){const i=s[1];return{host:i,port:Xh(r.substr(i.length+1))}}else{const[i,a]=r.split(":");return{host:i,port:Xh(a)}}}function Xh(n){if(!n)return null;const e=Number(n);return isNaN(e)?null:e}function RI(){function n(){const e=document.createElement("p"),t=e.style;e.innerText="Running in emulator mode. Do not use with production credentials.",t.position="fixed",t.width="100%",t.backgroundColor="#ffffff",t.border=".1em solid #000000",t.color="#b50000",t.bottom="0px",t.left="0px",t.margin="0px",t.zIndex="10000",t.textAlign="center",e.classList.add("firebase-emulator-warning"),document.body.appendChild(e)}typeof console<"u"&&typeof console.info=="function"&&console.info("WARNING: You are using the Auth Emulator, which is intended for local testing only.  Do not use with production credentials."),typeof window<"u"&&typeof document<"u"&&(document.readyState==="loading"?window.addEventListener("DOMContentLoaded",n):n())}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Wt extends bi{constructor(){super("google.com"),this.addScope("profile")}static credential(e,t){return Tr._fromParams({providerId:Wt.PROVIDER_ID,signInMethod:Wt.GOOGLE_SIGN_IN_METHOD,idToken:e,accessToken:t})}static credentialFromResult(e){return Wt.credentialFromTaggedObject(e)}static credentialFromError(e){return Wt.credentialFromTaggedObject(e.customData||{})}static credentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{oauthIdToken:t,oauthAccessToken:r}=e;if(!t&&!r)return null;try{return Wt.credential(t,r)}catch{return null}}}Wt.GOOGLE_SIGN_IN_METHOD="google.com";Wt.PROVIDER_ID="google.com";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bw(n){switch(n){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";case"WebExtension":return"web-extension";default:return}}function jw(n){rs(new Er("auth",(e,{options:t})=>{const r=e.getProvider("app").getImmediate(),s=e.getProvider("heartbeat"),i=e.getProvider("app-check-internal"),{apiKey:a,authDomain:c}=r.options;ne(a&&!a.includes(":"),"invalid-api-key",{appName:r.name});const l={apiKey:a,authDomain:c,clientPlatform:n,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:sg(n)},h=new yI(r,s,i,l);return AI(h,t),h},"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback((e,t,r)=>{e.getProvider("auth-internal").initialize()})),rs(new Er("auth-internal",e=>{const t=da(e.getProvider("auth").getImmediate());return(r=>new Uw(r))(t)},"PRIVATE").setInstantiationMode("EXPLICIT")),qn(of,af,Bw(n)),qn(of,af,"esm2017")}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ir=new pl("@firebase/firestore");function Br(){return Ir.logLevel}function K(n,...e){if(Ir.logLevel<=he.DEBUG){const t=e.map(Pl);Ir.debug(`Firestore (${ps}): ${n}`,...t)}}function wn(n,...e){if(Ir.logLevel<=he.ERROR){const t=e.map(Pl);Ir.error(`Firestore (${ps}): ${n}`,...t)}}function Wn(n,...e){if(Ir.logLevel<=he.WARN){const t=e.map(Pl);Ir.warn(`Firestore (${ps}): ${n}`,...t)}}function Pl(n){if(typeof n=="string")return n;try{/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Tf(n){let e=0;for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e++;return e}function Sr(n,e){for(const t in n)Object.prototype.hasOwnProperty.call(n,t)&&e(t,n[t])}function kg(n){for(const e in n)if(Object.prototype.hasOwnProperty.call(n,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vb{constructor(){this.changes=new Rr((e=>e.toString()),((e,t)=>e.isEqual(t))),this.changesApplied=!1}addEntry(e){this.assertNotApplied(),this.changes.set(e.key,e)}removeEntry(e,t){this.assertNotApplied(),this.changes.set(e,ct.newInvalidDocument(e).setReadTime(t))}getEntry(e,t){this.assertNotApplied();const r=this.changes.get(t);return r!==void 0?D.resolve(r):this.getFromCache(e,t)}getEntries(e,t){return this.getAllFromCache(e,t)}apply(e){return this.assertNotApplied(),this.changesApplied=!0,this.applyChanges(e)}assertNotApplied(){}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $b{constructor(){this.As=!1,this.Rs=!1,this.Vs=100,this.fs=(function(){return CE()?8:mA(ut())>0?6:4})()}initialize(e,t){this.gs=e,this.indexManager=t,this.As=!0}getDocumentsMatchingQuery(e,t,r,s){const i={result:null};return this.ps(e,t).next((a=>{i.result=a})).next((()=>{if(!i.result)return this.ys(e,t,s,r).next((a=>{i.result=a}))})).next((()=>{if(i.result)return;const a=new jb;return this.ws(e,t,a).next((c=>{if(i.result=c,this.Rs)return this.Ss(e,t,a,c.size)}))})).next((()=>i.result))}Ss(e,t,r,s){return r.documentReadCount<this.Vs?(Br()<=he.DEBUG&&K("QueryEngine","SDK will not create cache indexes for query:",jr(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Vs,"documents"),D.resolve()):(Br()<=he.DEBUG&&K("QueryEngine","Query:",jr(t),"scans",r.documentReadCount,"local documents and returns",s,"documents as results."),r.documentReadCount>this.fs*s?(Br()<=he.DEBUG&&K("QueryEngine","The SDK decides to create cache indexes for query:",jr(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,Qt(t))):D.resolve())}ps(e,t){if(kf(t))return D.resolve(null);let r=Qt(t);return this.indexManager.getIndexType(e,r).next((s=>s===0?null:(t.limit!==null&&s===1&&(t=Bc(t,null,"F"),r=Qt(t)),this.indexManager.getDocumentsMatchingTarget(e,r).next((i=>{const a=fe(...i);return this.gs.getDocuments(e,a).next((c=>this.indexManager.getMinOffset(e,r).next((l=>{const h=this.bs(t,c);return this.Ds(t,h,a,l.readTime)?this.ps(e,Bc(t,null,"F")):this.vs(e,h,t,l)}))))})))))}ys(e,t,r,s){return kf(t)||s.isEqual(se.min())?D.resolve(null):this.gs.getDocuments(e,r).next((i=>{const a=this.bs(t,i);return this.Ds(t,a,r,s)?D.resolve(null):(Br()<=he.DEBUG&&K("QueryEngine","Re-using previous result from %s to execute query: %s",s.toString(),jr(t)),this.vs(e,a,t,hA(s,fi)).next((c=>c)))}))}bs(e,t){let r=new Ke(Gg(e));return t.forEach(((s,i)=>{Ta(e,i)&&(r=r.add(i))})),r}Ds(e,t,r,s){if(e.limit===null)return!1;if(r.size!==t.size)return!0;const i=e.limitType==="F"?t.last():t.first();return!!i&&(i.hasPendingWrites||i.version.compareTo(s)>0)}ws(e,t,r){return Br()<=he.DEBUG&&K("QueryEngine","Using full collection scan to execute query:",jr(t)),this.gs.getDocumentsMatchingQuery(e,t,Gn.min(),r)}vs(e,t,r,s){return this.gs.getDocumentsMatchingQuery(e,r,s).next((i=>(t.forEach((a=>{i=i.insert(a.key,a)})),i)))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const wr="RemoteStore";class l0{constructor(e,t,r,s,i){this.localStore=e,this.datastore=t,this.asyncQueue=r,this.remoteSyncer={},this.Pa=[],this.Ta=new Map,this.Ia=new Set,this.da=[],this.Ea=i,this.Ea.xo((a=>{r.enqueueAndForget((async()=>{Cr(this)&&(K(wr,"Restarting streams for network reachability change."),await(async function(l){const h=ie(l);h.Ia.add(4),await ki(h),h.Aa.set("Unknown"),h.Ia.delete(4),await Sa(h)})(this))}))})),this.Aa=new c0(r,s)}}async function Sa(n){if(Cr(n))for(const e of n.da)await e(!0)}async function ki(n){for(const e of n.da)await e(!1)}function Im(n,e){const t=ie(n);t.Ta.has(e.targetId)||(t.Ta.set(e.targetId,e),Kl(t)?Wl(t):_s(t).x_()&&zl(t,e))}function Hl(n,e){const t=ie(n),r=_s(t);t.Ta.delete(e),r.x_()&&wm(t,e),t.Ta.size===0&&(r.x_()?r.B_():Cr(t)&&t.Aa.set("Unknown"))}function zl(n,e){if(n.Ra.$e(e.targetId),e.resumeToken.approximateByteSize()>0||e.snapshotVersion.compareTo(se.min())>0){const t=n.remoteSyncer.getRemoteKeysForTarget(e.targetId).size;e=e.withExpectedCount(t)}_s(n).H_(e)}function wm(n,e){n.Ra.$e(e),_s(n).Y_(e)}function Wl(n){n.Ra=new rb({getRemoteKeysForTarget:e=>n.remoteSyncer.getRemoteKeysForTarget(e),Et:e=>n.Ta.get(e)||null,lt:()=>n.datastore.serializer.databaseId}),_s(n).start(),n.Aa.aa()}function Kl(n){return Cr(n)&&!_s(n).M_()&&n.Ta.size>0}function Cr(n){return ie(n).Ia.size===0}function Am(n){n.Ra=void 0}async function u0(n){n.Aa.set("Online")}async function h0(n){n.Ta.forEach(((e,t)=>{zl(n,e)}))}async function f0(n,e){Am(n),Kl(n)?(n.Aa.la(e),Wl(n)):n.Aa.set("Unknown")}async function d0(n,e,t){if(n.Aa.set("Online"),e instanceof cm&&e.state===2&&e.cause)try{await(async function(s,i){const a=i.cause;for(const c of i.targetIds)s.Ta.has(c)&&(await s.remoteSyncer.rejectListen(c,a),s.Ta.delete(c),s.Ra.removeTarget(c))})(n,e)}catch(r){K(wr,"Failed to remove targets %s: %s ",e.targetIds.join(","),r),await Qo(n,r)}else if(e instanceof Io?n.Ra.Ye(e):e instanceof am?n.Ra.it(e):n.Ra.et(e),!t.isEqual(se.min()))try{const r=await vm(n.localStore);t.compareTo(r)>=0&&await(function(i,a){const c=i.Ra.Pt(a);return c.targetChanges.forEach(((l,h)=>{if(l.resumeToken.approximateByteSize()>0){const d=i.Ta.get(h);d&&i.Ta.set(h,d.withResumeToken(l.resumeToken,a))}})),c.targetMismatches.forEach(((l,h)=>{const d=i.Ta.get(l);if(!d)return;i.Ta.set(l,d.withResumeToken(et.EMPTY_BYTE_STRING,d.snapshotVersion)),wm(i,l);const p=new Un(d.target,l,h,d.sequenceNumber);zl(i,p)})),i.remoteSyncer.applyRemoteEvent(c)})(n,t)}catch(r){K(wr,"Failed to raise snapshot:",r),await Qo(n,r)}}async function Qo(n,e,t){if(!ms(e))throw e;n.Ia.add(1),await ki(n),n.Aa.set("Offline"),t||(t=()=>vm(n.localStore)),n.asyncQueue.enqueueRetryable((async()=>{K(wr,"Retrying IndexedDB access"),await t(),n.Ia.delete(1),await Sa(n)}))}function bm(n,e){return e().catch((t=>Qo(n,t,e)))}async function Ra(n){const e=ie(n),t=Yn(e);let r=e.Pa.length>0?e.Pa[e.Pa.length-1].batchId:Vl;for(;p0(e);)try{const s=await Qb(e.localStore,r);if(s===null){e.Pa.length===0&&t.B_();break}r=s.batchId,g0(e,s)}catch(s){await Qo(e,s)}Sm(e)&&Rm(e)}function p0(n){return Cr(n)&&n.Pa.length<10}function g0(n,e){n.Pa.push(e);const t=Yn(n);t.x_()&&t.Z_&&t.X_(e.mutations)}function Sm(n){return Cr(n)&&!Yn(n).M_()&&n.Pa.length>0}function Rm(n){Yn(n).start()}async function m0(n){Yn(n).na()}async function _0(n){const e=Yn(n);for(const t of n.Pa)e.X_(t.mutations)}async function y0(n,e,t){const r=n.Pa.shift(),s=Ll.from(r,e,t);await bm(n,(()=>n.remoteSyncer.applySuccessfulWrite(s))),await Ra(n)}async function v0(n,e){e&&Yn(n).Z_&&await(async function(r,s){if((function(a){return tb(a)&&a!==k.ABORTED})(s.code)){const i=r.Pa.shift();Yn(r).N_(),await bm(r,(()=>r.remoteSyncer.rejectFailedWrite(i.batchId,s))),await Ra(r)}})(n,e),Sm(n)&&Rm(n)}async function Qf(n,e){const t=ie(n);t.asyncQueue.verifyOperationInProgress(),K(wr,"RemoteStore received new credentials");const r=Cr(t);t.Ia.add(3),await ki(t),r&&t.Aa.set("Unknown"),await t.remoteSyncer.handleCredentialChange(e),t.Ia.delete(3),await Sa(t)}async function E0(n,e){const t=ie(n);e?(t.Ia.delete(2),await Sa(t)):e||(t.Ia.add(2),await ki(t),t.Aa.set("Unknown"))}function _s(n){return n.Va||(n.Va=(function(t,r,s){const i=ie(t);return i.ia(),new s0(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:u0.bind(null,n),e_:h0.bind(null,n),n_:f0.bind(null,n),J_:d0.bind(null,n)}),n.da.push((async e=>{e?(n.Va.N_(),Kl(n)?Wl(n):n.Aa.set("Unknown")):(await n.Va.stop(),Am(n))}))),n.Va}function Yn(n){return n.ma||(n.ma=(function(t,r,s){const i=ie(t);return i.ia(),new i0(r,i.connection,i.authCredentials,i.appCheckCredentials,i.serializer,s)})(n.datastore,n.asyncQueue,{Zo:()=>Promise.resolve(),e_:m0.bind(null,n),n_:v0.bind(null,n),ea:_0.bind(null,n),ta:y0.bind(null,n)}),n.da.push((async e=>{e?(n.ma.N_(),await Ra(n)):(await n.ma.stop(),n.Pa.length>0&&(K(wr,`Stopping write stream with ${n.Pa.length} pending writes`),n.Pa=[]))}))),n.ma}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */qn(gS,mS,"app");const _S={apiKey:"AIzaSyB4bdNSxAmLtSHuGqV7rV05qdSDF2tMEbc",authDomain:"custombeverage-46482.firebaseapp.com",projectId:"custombeverage-46482",storageBucket:"custombeverage-46482.firebasestorage.app",messagingSenderId:"524235465163",appId:"1:524235465163:web:f2d61e0a53c05b4d57164e",measurementId:"G-PZS8NST5EP"},yS=Up(_S),Lr=Q0(yS),Bn=sE("BeverageStore",{state:()=>({user:null,temps:lf,currentTemp:lf[0],bases:[],currentBase:null,syrups:[],currentSyrup:null,creamers:[],currentCreamer:null,beverages:[],currentBeverage:null,currentName:"",userBev:[]}),actions:{init(){if(this.bases.length>0)return;const n=Ls(Lr,"bases");ao(n).then(r=>{r.forEach(s=>{this.bases.push(s.data()),this.currentBase=this.bases[0]})});const e=Ls(Lr,"syrups");ao(e).then(r=>{r.forEach(s=>{this.syrups.push(s.data()),this.currentSyrup=this.syrups[0]})});const t=Ls(Lr,"creamers");ao(t).then(r=>{r.forEach(s=>{this.creamers.push(s.data()),this.currentCreamer=this.creamers[0]})})},setUser(n){const e="account/"+n,t=Hm(Lr,e);hS(t).then(r=>{var s;if(r.exists()){const a=Ls(Lr,"savedBeverage"),c=aS(a,cS("email","==",(s=this.user)==null?void 0:s.email));ao(c).then(l=>{l.forEach(h=>{this.userBev.push(h.data())})}).finally(()=>this.userBev.forEach(l=>this.beverages.push(l.savedBev)))}else fS(t,{id:n})}).catch(r=>console.log("error",r))},makeBeverage(n){var s;if(this.user==null)return;const e={id:n+this.user.email,name:n,temp:this.currentTemp,base:this.currentBase,syrup:this.currentSyrup,creamer:this.currentCreamer},r=Ls(Lr,"savedBeverage");dS(r,{savedBev:e,email:(s=this.user)==null?void 0:s.email}),this.beverages.push(e)},showBeverage(n){this.currentTemp=n.temp,this.currentBase=n.base,this.currentSyrup=n.syrup,this.currentCreamer=n.creamer}}}),vS=Ei({__name:"Syrup",setup(n){const e=Bn();return(t,r)=>{var s;return pe(),Ve("div",{class:"syrup",style:us({"--texture-color":(s=Ee(e).currentSyrup)==null?void 0:s.color})},null,4)}}}),ES=br(vS,[["__scopeId","data-v-2fa3a41a"]]),TS=Ei({__name:"Base",setup(n){const e=Bn();return(t,r)=>{var s;return pe(),Ve("div",{class:"baseBeverage",style:us({backgroundColor:(s=Ee(e).currentBase)==null?void 0:s.color})},null,4)}}}),IS=br(TS,[["__scopeId","data-v-8cc1f7b4"]]),wS={class:"froth"},AS=Ei({__name:"Creamer",setup(n){const e=Bn();return(t,r)=>(pe(),Ve("div",wS,[(pe(),Ve(Fe,null,Nn(5,()=>{var s;return be("div",{class:"foam",style:us({backgroundColor:(s=Ee(e).currentCreamer)==null?void 0:s.color})},null,4)}),64))]))}}),bS=br(AS,[["__scopeId","data-v-84d3ef89"]]),SS={},RS={id:"steam"},PS={class:"stream"};function CS(n,e){return pe(),Ve("div",RS,[(pe(),Ve(Fe,null,Nn(3,()=>be("div",PS)),64))])}const VS=br(SS,[["render",CS]]),kS={},DS={id:"condensation"},OS={class:"flake"};function NS(n,e){return pe(),Ve("div",DS,[(pe(),Ve(Fe,null,Nn(3,()=>be("div",OS)),64))])}const xS=br(kS,[["render",NS]]),MS=Ei({__name:"Beverage",props:{isIced:{type:Boolean}},setup(n){const e=Bn();return(t,r)=>(pe(),xn(eA,null,{default:Fs(()=>[n.isIced?(pe(),xn(xS,{key:0})):(pe(),xn(VS,{key:1})),Tt(Jw,null,{top:Fs(()=>{var s;return[((s=Ee(e).currentCreamer)==null?void 0:s.color)!=="transparent"?(pe(),xn(bS,{key:0})):Hr("",!0)]}),mid:Fs(()=>{var s;return[((s=Ee(e).currentSyrup)==null?void 0:s.color)!=="transparent"?(pe(),xn(ES,{key:0})):Hr("",!0)]}),bottom:Fs(()=>[Tt(IS)]),_:1})]),_:1}))}}),LS=["id","value"],FS=["id","value"],US=["id","value"],BS=["id","value"],jS={key:0},$S={key:1},qS={key:0},HS={key:1},zS=["onClick"],WS=Ei({__name:"App",setup(n){const e=zw(),t=new Wt,r=Bn(),{showBeverage:s}=Bn(),{setUser:i}=Bn(),{makeBeverage:a}=Bn();var c="";Qd(()=>r.init());const l=()=>{ew(e,t).then(d=>{Wt.credentialFromResult(d),r.user=d.user}).catch(d=>{console.error("Sign in failed ",d)}).finally(()=>{var d;i((d=r.user)==null?void 0:d.email)})},h=()=>{NI(e,d=>{d!=null&&(r.user=null,r.beverages=[],r.userBev=[])})};return(d,p)=>(pe(),Ve(Fe,null,[be("div",null,[Tt(MS,{isIced:Ee(r).currentTemp==="Cold"},null,8,["isIced"]),be("ul",null,[be("li",null,[(pe(!0),Ve(Fe,null,Nn(Ee(r).temps,m=>(pe(),Ve("label",{key:m},[xs(be("input",{type:"radio",name:"temperature",id:`r${m}`,value:m,"onUpdate:modelValue":p[0]||(p[0]=b=>Ee(r).currentTemp=b)},null,8,LS),[[eo,Ee(r).currentTemp]]),Ur(" "+lr(m),1)]))),128))])]),be("ul",null,[be("li",null,[(pe(!0),Ve(Fe,null,Nn(Ee(r).bases,m=>(pe(),Ve("label",{key:m.id},[xs(be("input",{type:"radio",name:"bases",id:`r${m.id}`,value:m,"onUpdate:modelValue":p[1]||(p[1]=b=>Ee(r).currentBase=b)},null,8,FS),[[eo,Ee(r).currentBase]]),Ur(" "+lr(m.name),1)]))),128))])]),be("ul",null,[be("li",null,[(pe(!0),Ve(Fe,null,Nn(Ee(r).syrups,m=>(pe(),Ve("label",{key:m.id},[xs(be("input",{type:"radio",name:"syrups",id:`r${m.id}`,value:m,"onUpdate:modelValue":p[2]||(p[2]=b=>Ee(r).currentSyrup=b)},null,8,US),[[eo,Ee(r).currentSyrup]]),Ur(" "+lr(m.name),1)]))),128))])]),be("ul",null,[be("li",null,[(pe(!0),Ve(Fe,null,Nn(Ee(r).creamers,m=>(pe(),Ve("label",{key:m.id},[xs(be("input",{type:"radio",name:"creamers",id:`r${m.id}`,value:m,"onUpdate:modelValue":p[3]||(p[3]=b=>Ee(r).currentCreamer=b)},null,8,BS),[[eo,Ee(r).currentCreamer]]),Ur(" "+lr(m.name),1)]))),128))])]),Ee(r).user==null?(pe(),Ve("div",jS,[be("button",{onClick:l},"Log in to brew")])):Hr("",!0),Ee(r).user!==null?(pe(),Ve("div",$S,[be("span",null,"Welcome "+lr(Ee(r).user.displayName),1),be("button",{onClick:h},"Log out")])):Hr("",!0),xs(be("input",{type:"text",placeholder:"Beverage Name","onUpdate:modelValue":p[4]||(p[4]=m=>Ne(c)?c.value=m:c=m)},null,512),[[zv,Ee(c)]]),be("button",{onClick:p[5]||(p[5]=m=>Ee(a)(Ee(c)))},"🍺 Make Beverage")]),be("div",null,[Ee(r).user==null?(pe(),Ve("p",qS,"Please sign in before make beverages")):Hr("",!0),Ee(r).user!==null?(pe(),Ve("ul",HS,[be("li",null,[(pe(!0),Ve(Fe,null,Nn(Ee(r).beverages,m=>(pe(),Ve("label",{key:m.id},[be("input",{onClick:b=>Ee(s)(m),name:"beverage",type:"radio"},null,8,zS),Ur(" "+lr(m.name),1)]))),128))])])):Hr("",!0)]),p[6]||(p[6]=be("div",{id:"beverage-container",style:{"margin-top":"20px"}},null,-1))],64))}}),r_=Yv();r_.use(lE);Qv(WS).use(r_).mount("#app");
